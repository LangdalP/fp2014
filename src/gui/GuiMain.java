...
//			JOptionPane.showMessageDialog(null, "Alarm for m�te: " + meeting.getDescription() + ", m�terom: " + meeting.getMeetingRoom().getName() + " kl: " + meeting.getMeetingTime().toString());		
//		}
//		else{
			JOptionPane.showMessageDialog(null, "Alarm for m�te: " + meeting.getDescription() + ", sted: " + meeting.getMeetngLocation() + " kl: " + meeting.getMeetingTime().toString());
//		}
	}
	...
	public void propertyChange(PropertyChangeEvent evt) {
		...
		if (evt.getPropertyName().equals(EDIT_MEETING)) {
            ...
            mModel.addOwnerToAttendees(model.getMapEmployees().get(model.getUsername()));
